export function showMenu(start1v1Callback, startTournamentCallback, startCpuGameCallback) {
	...
	const start1v1Button = document.getElementById('startButton');
	const startTournamentButton = document.getElementById('startTournamentButton');
	const startCpuGameButton = document.getElementById('startCpuGameButton');
	...
	const newStart1v1Button = document.getElementById('startButton');
	const newStartTournamentButton = document.getElementById('startTournamentButton');
	const newStartCpuGameButton = document.getElementById('startCpuGameButton');
